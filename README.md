...
1. Explain what a token is used for.
   It is a string of cryptic text. It has the data coming from the server, but can't be read by anyone except if they have the key to un-code it.
2. What steps can you take in your web apps to keep your data secure?
   One way would be to have private routes, that can be accessed after the user is logged in.
3. Describe how web servers work.
   A web server is an actual computer that stores the code for a website and puts it on the internet. It also has the code to run that website
4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
   GET, POST, PUT, DELETE are the four main (most used) HTTP methods
